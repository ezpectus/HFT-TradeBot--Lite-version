...
public:
    ...
    // Build Logout (35=5)
    static FixMessage build_logout(
        const char* sender_comp_id,
        const char* target_comp_id,
        uint32_t seq_num,
        const char* text = ""
    ...
    static FixMessage build_heartbeat(
        const char* sender_comp_id,
        const char* target_comp_id,
        uint32_t seq_num,
        const char* test_req_id = ""
    ) {
        FixMessage msg;
    ...
    static FixMessage build_test_request(
        const char* sender_comp_id,
        const char* target_comp_id,
        uint32_t seq_num,
        const char* test_req_id
    ...
    static FixMessage build_resend_request(
        const char* sender_comp_id,
        const char* target_comp_id,
        uint32_t seq_num,
    ...
    static FixMessage build_new_order_single(
        const char* sender_comp_id,
        const char* target_comp_id,
        uint32_t seq_num,
    ...
    static FixMessage build_order_cancel(
        const char* sender_comp_id,
        const char* target_comp_id,
        uint32_t seq_num,
        const char* orig_cl_ord_id,
        const char* cl_ord_id,
        const char* symbol,
        char side
    ) {
