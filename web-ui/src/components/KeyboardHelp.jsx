...
const SHORTCUTS = [
  ...
  { keys: ['A'], desc: 'Account tab' },
  { keys: ['B'], desc: 'Bots tab' },
  { keys: ['S'], desc: 'Signals tab' },
  { keys: ['R'], desc: 'Arbitrage tab' },
  { keys: ['P'], desc: 'Prices tab' },
  { keys: ['F'], desc: 'Fills tab' },
  { keys: ['H'], desc: 'History tab' },
  { keys: ['T'], desc: 'Performance tab' },
  { keys: ['M'], desc: 'Toggle dark / light theme' },
